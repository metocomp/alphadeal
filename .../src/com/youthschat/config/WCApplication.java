...
//		XmppConnectionManager.getInstance().disconnect();
		...
		setProperties(new Properties(){
			{
				...
				setProperty("user.email", user.userInfo.userEmail);
		...
		setProperties(new Properties(){
			{
				...
				if (StringUtils.notEmpty(user.userEmail)) {
					setProperty("user.userEmail", user.userEmail);
				}
	...
	public UserEntity getLoginInfo() {		
		...
		userInfo.userEmail = (getProperty("user.email"));
