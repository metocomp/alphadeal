...
import com.youthschat.javaBellsSample.JavaBellsSample2;
import com.youthschat.qiniu.auth.JSONObjectRet;
import com.youthschat.qiniu.io.IO;
import com.youthschat.qiniu.io.PutExtra;
import com.youthschat.qiniu.utils.Config;
import com.youthschat.qiniu.utils.Mac;
import com.youthschat.qiniu.utils.PutPolicy;
import com.youthschat.tools.AudioPlayManager;
import com.youthschat.tools.AudioRecoderManager;
...
//				.getChatCountWithSb(to);
	...
	private void PhotoChooseOption() {
		closeInput();
		CharSequence[] item = {"Send From Gallery", "Take Photo", "Video Chat"};
					...
					public void onClick(DialogInterface dialog, int item)
					{
						...
						{	
							...
							if(StringUtils.empty(savePath)){
								UIHelper.ToastMessage(Chating.this, "Please check SD card", Toast.LENGTH_SHORT);
								return;
							}
							...
							new JavaBellsSample2("8a80818a47998787014799e73ee10002", "888888", "10.0.1.10", "CALL");
						}
					}}).create();
			 imageDialog.show();
	}
...
//			.showImageOnFail(R.drawable.content_image_loading)
				...
				if (convertView == null) {
					if (message.getMsgType() == 0) {
						...
						case CommonValue.kWCMessageTypePlain:
							...
							TextView leftText = (TextView) convertView.findViewById(R.id.textview_content_l);
							registerForContextMenu(leftText);
							holderLeftText.leftText = leftText;
						...
						case CommonValue.kWCMessageTypePlain:
							...
							TextView rightText = (TextView) convertView.findViewById(R.id.textview_content_r);
							registerForContextMenu(rightText);
							holderRightText.rightText = rightText;
		...
		private void displayTime(int position, TextView timeTV) {
			...
			try {
				...
				if ((time1-time2) >= 5 * 60 ) {
					...
					timeTV.setText(Utils.formatTime(context, currentTime));
				}
				else {
				...
				public void onProcess(long current, long total) {
					if (messageType == CommonValue.kWCMessageTypePlain) {
						...
						if ((int)percent < 100) {
							...
							cell.photoProgress.setText("Processing...");
						}
					}
				}
	...
	public void onItemClick(AdapterView<?> arg0, View convertView, int position, long arg3) {
		if (convertView.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice) {
			com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice viewHolderLeftVoice = (com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice) convertView.getTag();
		...
		else if (convertView.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice) {
			com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice viewHolderRightVoice = (com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice) convertView.getTag();
		...
		else if (convertView.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftImage) {
			
		}
		else if (convertView.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightImage) {
	...
	public void playStoped(View messageBubble) {
		if (messageBubble.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice) {
			com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice viewHolderLeftVoice = (com.youthschat.im.Chating.MessageListAdapter.ViewHolderLeftVoice) messageBubble.getTag();
		...
		else if (messageBubble.getTag() instanceof com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice) {
			com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice viewHolderRightVoice = (com.youthschat.im.Chating.MessageListAdapter.ViewHolderRightVoice) messageBubble.getTag();
	...
	public boolean onEditorAction(TextView view, int actionId, KeyEvent arg2) {
		...
		case EditorInfo.IME_ACTION_SEND:
			...
			if ("".equals(message)) {
				Toast.makeText(Chating.this, "Empty is not allowed",
