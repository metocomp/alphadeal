...
public class UpdateManager {
    ...
    private Handler mHandler = new Handler(){
    	public void handleMessage(Message msg) {
			...
			case DOWN_NOSDCARD:
				downloadDialog.dismiss();
				UIHelper.ToastMessage(mContext, R.layout.toastmessage_text, "Download failed", Toast.LENGTH_SHORT);
				break;
			}
    	};
    };
	...
	public void checkAppUpdate(final Context context, final boolean isShowMsg){
		...
		if(isShowMsg){
			if(mProDialog == null)
				mProDialog = ProgressDialog.show(mContext, null, "Please hold on...", true, true);
...
//		});
	...
	private void showLatestOrFailDialog(int dialogType) {
		...
		if (dialogType == DIALOG_TYPE_LATEST) {
			builder.setMessage("You are already up-to-date");
	...
	private void showNoticeDialog(){
		AlertDialog.Builder builder = new Builder(mContext);
		builder.setTitle("YouthsChat has an undated version");
		builder.setMessage(updateMsg);
		builder.setPositiveButton("Ask me later", new OnClickListener() {			
			@Override
...
//				}
		...
		builder.setNegativeButton("Update now", new OnClickListener() {			
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();	
				showDownloadDialog();
